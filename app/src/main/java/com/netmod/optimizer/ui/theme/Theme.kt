package com.netmod.optimizer.ui.theme
...
import com.netmod.optimizer.core.DarkPalette
import com.netmod.optimizer.core.LightPalette
import com.netmod.optimizer.core.Palette
...
@Composable
fun NetModTheme(dark: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
